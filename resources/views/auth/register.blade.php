                ...
                <div class="card-body p-4">
                    <form method="post" action="{{ url('/register') }}">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control {{ $errors->has('cedula')?'is-invalid':'' }}" name="cedula" value="{{ old('cedula') }}"
                                   placeholder="Cedula">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control {{ $errors->has('numero_celular')?'is-invalid':'' }}" name="numero_celular" value="{{ old('numero_celular') }}"
